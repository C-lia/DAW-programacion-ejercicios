...
public class RepasoT3 {
     ...
     * introducidas por teclado y en caso de que esa media sea superior a 6.5,
     ...
     * introducidos por el usuario (no usar bucles, se sabe que serán 5
     * números). Hay que controlar además, que los valores de introducidos sean
    ...
    /**
     * Ejercicio 9: Realiza un algoritmo que indique si un año es bisiesto o no.
     * Un año es bisiesto si es divisible entre 4 y no es divisible entre 100 o
    ...
    /**
     * Ejercicio 11: Pregunta el nombre de dos jugadores. A continuación, simula
     * una partida de tirada de dados: el primer jugador tira un dado de 6 caras
     * y saca una puntuación. Luego hace lo mismo el segundo jugador. Al final
     * se indica que jugador ha ganado.
     */
    public void ejercicio11() {
        System.out.println("Tira el primer jugador");
        double jugador1 = consola.nextDouble();
        System.out.println("Tira el segundo jugador");
        double jugador2 = consola.nextDouble();

        if (jugador1 < 7 && jugador2 < 7 && jugador1 > 0 && jugador2 > 0) {
            int tirada1 = (int) (Math.random() * jugador1 + 1);
            int tirada2 = (int) (Math.random() * jugador2 + 1);
    ...
    public void ejercicio14() {
        ...
        if (email.equals(datoEmail) && contraseña.equals(datoContraseña)) {
            codigo = (int) (Math.random() * Math.pow(10, 4));
        ...
        if (emailVerificar.equals(email) && contraseñaVerificar.equals(contraseña) && codigoVerificar == codigo) {
            System.out.println("Verificacion aceptada" + "\nBienvenid@: " + nick);
        } else {
            System.out.println("Los datos introducidos son incorrectos");
        }

        // Arreglar que no se salga lo siguiente si no ha saido verificado
        // Idea1: convertir el primer if a ternario para poder guardarlo en variables. 
        // Idea2: Meter el 2 bloque de sout dentro del primer if-else y el segundo if hacerlo ternario para meterlo dentro y que no quede tan raro un if dentro de otro.
    }

    /**
     * Ejercicio 15: Una empresa maneja números enteros positivos de 4 dígitos
    ...
    public void ejercicio15() {
        ...
        final int LONGITUD_REQUERIDA = 4;
        System.out.println("Introduce los numeros de 4 digitos");
        int n = consola.nextInt();

        String cadena = Integer.toString(n);

        boolean tieneLongitudRequerida = cadena.length() == LONGITUD_REQUERIDA;
    ...
    public void ejercicio16() {
        ...
        double billetes500 = dinero % 500;
        double billetes200 = billetes500 % 200;
        
        System.out.println((int)billetes500 + " " + (int)billetes200);
